...
Shader "MyShaders/Banner"
{
	Properties
	{
		...
		_WaveYDirection("Wave Y Direction", Range( -1 , 1)) = 0
		_NAbyWindGradient("NA by Wind Gradient", Range( 0 , 1)) = 0.81
		_WaveDirectionMultiplierX("Wave Direction Multiplier X", Range( -1 , 2)) = 0
		_WaveDirectionMultiplierZ("Wave Direction Multiplier Z", Range( 0 , 2)) = 0.1351686
	...
	SubShader
	{
		...
		uniform float _WaveYDirection;
		uniform float _WaveDirectionMultiplierZ;
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float temp_output_93_0 = ( 1.0 - ( _NAbywindPosition + ( _NAbyWindGradient * ase_vertex3Pos.z ) ) );
			...
			float3 appendResult150 = (float3(0.0 , _WaveYDirection , 0.0));
			v.vertex.xyz += ( ( temp_output_93_0 * tex2DNode77.r * ( float3(1,0,0) * _WaveDirectionMultiplierX ) ) + ( temp_output_93_0 * tex2DNode77.r * ( appendResult150 * _WaveDirectionMultiplierZ ) ) );
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( ( ( temp_output_68_0 * _BorderColor ) + ( _OutsideColor * ( temp_output_29_0 - temp_output_68_0 ) ) + ( ( 1.0 - temp_output_29_0 ) * _InsideColor ) ) * lerpResult130 ).rgb;
...
/*ASEBEGIN
Version=15301
683;217;1080;794;-118.1772;-1716.994;1;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-126.5048,913.3977;Float;False;Property;_NAbyWindGradient;NA by Wind Gradient;21;0;Create;True;0;0;False;0;0.81;0.15;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;88;-77.03027,987.54;Float;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;92;207.0591,937.5953;Float;False;Property;_NAbywindPosition;NA by wind Position;19;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;456.683,2067.506;Float;False;Property;_WaveDirectionMultiplierX;Wave Direction Multiplier X;22;0;Create;True;0;0;False;0;0;0.8;-1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;275.0201,1011.484;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;151;272,2240;Float;False;Property;_WaveYDirection;Wave Y Direction;20;0;Create;True;0;0;False;0;0;-0.84;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;150;587.9761,2215.971;Float;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;69;488.0128,-568.0048;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;91;545.0594,987.5953;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;86;752,1920;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;142;448,2336;Float;False;Property;_WaveDirectionMultiplierZ;Wave Direction Multiplier Z;23;0;Create;True;0;0;False;0;0.1351686;0.2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;93;781.4113,989.5598;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;752,2192;Float;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;124;264.683,1795.506;Float;False;Property;_AOIntensity;AO Intensity;18;0;Create;True;0;0;False;0;0;0.87;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;113;1344,16;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D7288508CDC9B935CDC5FD244E4331879CA2B777